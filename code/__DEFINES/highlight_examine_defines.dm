...
#define VIBEDESC_FRIEND "A loyal ally of the Pharos."
#define VIBEDESC_FOE "A disloyal enemy of the Pharos."
...
#define EXAMINEHIGHLIGHT_TOOLTIP_HERESYSEVERITY_ALARMING "<font color=[COLOR_HERESYSEVERITY_ALARMING]><b>This is a blatantly dangerous heretical item!</b></font><br>Carrying this out in the open is tantamount to declaring myself an enemy to those of the Pentacle or PSYDON. Those who serve the Divine Wills are likely to respond in kind."
#define EXAMINEHIGHLIGHT_TOOLTIP_HERESYSEVERITY_SUSPICIOUS "<font color=[COLOR_HERESYSEVERITY_SUSPICIOUS]><b>This is a suspicious heretical item!</b></font><br>It is considered heretical by any of the Midderland's faiths. Those who serve the Gods are likely to view me with suspicion and distrust <b>at best</b> if I am caught with it."
#define EXAMINEHIGHLIGHT_TOOLTIP_HERESYSEVERITY_ODD "<font color=[COLOR_HERESYSEVERITY_ODD]><b>An odd expression of faith...</b></font><br>It is not openly deemed heretical by the Temple or the Church. However, that does not stop it from being seen as unusual. I am likely to be given odd looks if I am seen with it and not much more, but more guarded (or paranoid) members of the Faith may not be so charitable."
#define EXAMINEHIGHLIGHT_TOOLTIP_HERESYSEVERITY_VERYODD "<font color=[COLOR_HERESYSEVERITY_ALARMING]><b>This is a blatantly weird item!</b></font><br>Carrying this out in the open is highly suspicious to clergy and others attuned to the Gods. Those who serve the Divine Wills are likely to respond with suspicion and distrust <b>at best</b> if I am caught with it."
...
#define EXAMINEHIGHLIGHT_TOOLTIP_VIBE_GOLGATHA "<font color=[COLOR_VIBE_GOLGATHA]><b>`Oh, how graceful His power was! And His sacrifice, ever so noble!`</b></font><br>This censer, well recognized within Pharos, is said to contain a volatile fragment of the <font color=[COLOR_VIBE_GOLGATHA]><b>Golgathan Stain</b></font>, a solidified shard of the Shattering's wounds, and a sacred artifact to those of Psydonian Faith. Such a relic is only entrusted within the loving hands of His Majesty's Holy Inquisition. They - or any other Psydonian belonging to another sect - will <b>very likely respond with violence</b> if I am not supposed to have it."
