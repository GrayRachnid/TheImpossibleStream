...
/obj/item/ingot/aalloy
	name = "decrepit ingot"
	desc = "A decrepit slab of wrought bronze, uncomfortably cold to the touch. The gales shift into whispers, when held for long enough; 'apotheosis commands sacrifice'."
