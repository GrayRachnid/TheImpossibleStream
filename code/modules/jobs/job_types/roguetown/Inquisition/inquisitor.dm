/datum/job/roguetown/inquisitor
	...
	tutorial = "You are a puritan of unmatched aptitude, adherent to the Psydonic doctrine and entrusted with the authority to lead a local sect. Otava - the Holy Host, \
	and largest Psydonian state, second to Naledi, has seen it fit to treat you like a silver-tipped olive branch, gifted to the to ward off the encroaching \
