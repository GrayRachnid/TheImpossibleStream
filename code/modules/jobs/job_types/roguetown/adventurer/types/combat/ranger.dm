...
/datum/advclass/ranger/wayfarer
	name = "Wayfarer"
	tutorial = "You've spent countless years homing many trades; man-hunting, picking locks, breaking into places you had no right being.. but you are no mere thief. You are trained to track men and recover stolen goods. And the lands beneath the Scar make for a prime paycheck.."
